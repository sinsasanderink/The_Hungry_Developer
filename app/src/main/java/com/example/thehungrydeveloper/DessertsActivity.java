...
public class DessertsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dish[] desserts = {
                ...
                new Dish("Mulberry and cardamon crumble", "Fresh mulberry and green cardamon topped with butter crumble", 699),
                new Dish("Lemon scones with chilli jam", "Vegan scones served with chilli jam and fresh coconut cream", 599),
                new Dish("Potato and banana vegan crepes", "Crispy veham crepes filles with fresh potato and banana", 599),
