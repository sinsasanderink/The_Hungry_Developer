...
public class StarterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dish[] dishes = {
                ...
                new Dish("Coconut and chocolate mousse","A creamy mousse made with fresh coconut and milk chocolate", 799),
                ...
                new Dish("Chickpea and chilli gyoza", "Thin pastry cases stuffed with frwsh chickpea and green chilli", 699),
